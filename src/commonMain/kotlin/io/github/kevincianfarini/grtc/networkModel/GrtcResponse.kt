...
@Serializable
public data class GrtcResponse(
    @SerialName("bustime-response") private val response: BusTimeResponse
) {
    val predictions: List<GrtcStopPrediction> get() = response.predictions
}

@Serializable
public data class BusTimeResponse(
